package irfan.sampling.trykotlinlang.otherway
...
import irfan.sampling.trykotlinlang.R
import irfan.sampling.trykotlinlang.Register
...
class Main2 : AppCompatActivity(), AnkoLogger{
    ...
    //buat class untuk memasukkan layout baru
